...
namespace WindowsFormsApp26
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            SolidBrush myTrum = new SolidBrush(Color.YellowGreen);
            SolidBrush myTrub = new SolidBrush(Color.ForestGreen);
            SolidBrush mySeа = new SolidBrush(Color.Gray);
            ...
            g.FillRectangle(myTrub, 450, 135, 35, 75); // 2 труба (прямоугольник)
    ...
    new Point(200,400),new Point(100,300)
            ...
            g.FillRectangle(myTrum, 260, 200, 350, 100); // палуба (прямоугольник)
            ...
            g.DrawEllipse(myStuff, 2, 60, 120, 120);
            g.FillEllipse(myWhat, 2, 60, 120, 120);
